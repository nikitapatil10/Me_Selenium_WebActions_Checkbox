...
public class LearnRadioButton {
	...
	public boolean checkElementIsEnabled(WebElement webElement) {
		...
		isEnabled = webElement.isDisplayed();
		return isEnabled;
	}
	...
	public void run() throws MalformedURLException {
		...
		radioFemale = driver.findElement(By.xpath("/html/body/div/div/div[2]/div[2]/div[1]/fieldset/div/div/div[1]/div/label/span[1]/span[1]/input"));
		...
		radioVeryGood = driver.findElement(By.xpath("/html/body/div/div/div[2]/div[2]/div[2]/fieldset/div/div/div[1]/div/label/span[1]/span[1]/input"));
		...
		radioYes = driver.findElement(By.xpath("/html/body/div/div/div[2]/div[2]/div[3]/fieldset/div/div/div[1]/div/label/span[1]/span[1]/input"));
		radioNo = driver.findElement(By.xpath("/html/body/div/div/div[2]/div[2]/div[3]/fieldset/div/div/div[2]/div/label"));
		...
		System.out.println("yes option is displayed: "+isen);
